  ...
  const heroSlides = [
    {
      ...
      subtitle: "Discover the latest trends in fashion for men and women. Quality meets style in every piece.",
    ...
    },
    {
      ...
      subtitle: "Stay ahead of fashion trends with our constantly updated collections.",
      background: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=1200&h=600&fit=crop",
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="container position-relative" style={{ zIndex: 2, paddingTop: '120px' }}>
          <div className="hero-content text-white">
            ...
            <div className="hero-buttons">
              <a href={heroSlides[currentSlide].buttonLink} className="btn btn-light btn-lg px-4 me-3">
      ...
      <div className="container my-5 py-5">
        <div className="text-center mb-5">
          ...
          <p className="lead text-muted">We're committed to bringing you the best fashion experience</p>
        </div>
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="p-4 feature-card text-center hover-lift">
              ...
              <p className="text-muted">
                Curated collections featuring the latest fashion trends for every season and occasion
              </p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="p-4 feature-card text-center hover-lift">
              ...
              <h5>Best Prices</h5>
              <p className="text-muted">
                Premium quality fashion at unbeatable prices with regular sales and discounts
              </p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="p-4 feature-card text-center hover-lift">
              ...
              <h5>Fast Delivery</h5>
              <p className="text-muted">
                Free shipping on orders over $75 • Express delivery available • Easy returns
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container-fluid px-0 mb-5">
        <div className="row g-0">
          <div className="col-md-6">
            <div className="category-card men-category text-center p-5 position-relative overflow-hidden"
                 style={{
              ...
              <div className="position-relative" style={{zIndex: 2}}>
                ...
                <a href="/shop?category=men" className="btn btn-light btn-lg px-4">
                  Shop Men's Fashion
                </a>
              </div>
            </div>
          ...
          <div className="col-md-6">
            <div className="category-card women-category text-center p-5 position-relative overflow-hidden"
                 style={{
              ...
              <div className="position-relative" style={{zIndex: 2}}>
                <img
                  ...
                  style={{ maxHeight: '280px', width: '100%', objectFit: 'cover' }}
                />
                <h3 className="text-white mb-3 display-6">Women's Collection</h3>
                <p className="text-white mb-4 fs-5">
                  Elegant fashion for every occasion
                </p>
                <a href="/shop?category=women" className="btn btn-light btn-lg px-4">
      ...
      <div id="best-sellers" className="container my-5 py-5">
        <div className="text-center mb-5">
          ...
          <p className="lead text-muted">Our most loved styles by thousands of customers</p>
        </div>
      ...
      <div className="reviews-section mt-5 py-5 bg-dark text-white">
        <div className="container">
          <h2 className="text-center mb-4 display-5">What Our Style Lovers Say</h2>
          <p className="text-center lead mb-5">Join thousands of satisfied customers who found their perfect style</p>
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="card review-card h-100 border-0 shadow">
                <div className="card-body text-center p-4">
                  ...
                  <p className="card-text fst-italic">
                    "The quality is amazing! I get compliments every time I wear my StyleHub blazer. The fit is perfect!"
                  </p>
                  <h6 className="card-subtitle mb-2 text-primary">- Michael T.</h6>
            ...
            <div className="col-md-4 mb-4">
              <div className="card review-card h-100 border-0 shadow">
                <div className="card-body text-center p-4">
                  ...
                  <div className="text-warning mb-3 fs-5">★★★★★</div>
                  <p className="card-text fst-italic">
                    "Fast shipping and perfect fit. The summer dress is even more beautiful in person. My new favorite store!"
                  </p>
                  <h6 className="card-subtitle mb-2 text-success">- Sarah L.</h6>
            ...
            <div className="col-md-4 mb-4">
              <div className="card review-card h-100 border-0 shadow">
                <div className="card-body text-center p-4">
                  ...
                  <div className="text-warning mb-3 fs-5">★★★★★</div>
                  <p className="card-text fst-italic">
                    "Great prices for designer quality. The handbag is stunning and holds all my essentials perfectly!"
                  </p>
                  <h6 className="card-subtitle mb-2 text-warning">- Jessica M.</h6>
          ...
          <div className="col-lg-6 text-center">
            <div className="newsletter-card p-5 rounded shadow">
              ...
              <p className="text-muted mb-4">
                Subscribe to get updates on new arrivals, special offers and style inspiration.
              </p>
